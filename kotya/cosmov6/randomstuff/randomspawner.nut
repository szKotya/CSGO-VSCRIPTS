...
function AnglesToDir(angles)
{
    ...
    class RandomSpawn
    {
        ...
        {
            map_brush.GetScriptScope().ServerChat("12" + handle, 0.01)
...
//Items
{
    ...
    {
        ScriptPrintMessageChatAll("work");
        ...
        for(local i = 0; i < items_list.len(); i++)
        {
            ...
            maker.__KeyValueFromString("Targetname", "ma_" + items_list[i]);
        ...
        if (CLASSIC_MOD)
        {
            ...
            maker.__KeyValueFromString("Targetname", "ma_" + TEMP_HEAL);
